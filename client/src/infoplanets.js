export const solarSystemPlanets = [
    {
      ...
      temperature: {
        surface: 167, // en °C, temperatura promedio superficial
      },
    ...
    },
    {
      ...
      moons: 79, // incluye las lunas más grandes: Ío, Europa, Ganimedes, Calisto
      interestingFacts: [
    ...
    },
    {
      ...
      moons: 83, // incluye Titán, la segunda luna más grande del Sistema Solar
      interestingFacts: [
    ...
    },
    {
      ...
      orbit: {
        ...
        rotationPeriod: -0.72, // en días terrestres (rotación retrógrada)
      },
      atmosphere: {
        composition: [
          { gas: "Hidrógeno (H₂)", percentage: 82.5 },
          { gas: "Helio (He)", percentage: 15.2 },
          { gas: "Metano (CH₄)", percentage: 2.3 },
        ],
        pressure: "Unknown", // atmósfera profunda desconocida
      },
      temperature: {
      ...
      interestingFacts: [
        "Urano rota de lado, con un eje inclinado a 98 grados, lo que causa estaciones extremas.",
        "Es uno de los planetas gigantes de hielo y es más frío que Neptuno.",
      ],
    },
    {
      name: "Neptuno",
      ...
      gravity: 11.15, // m/s²
      distanceFromSun: {
        perihelion: 4444.5e6, // en km
        aphelion: 4545.7e6, // en km
      },
      orbit: {
        eccentricity: 0.009,
      ...
      interestingFacts: [
        "Neptuno tiene los vientos más fuertes del Sistema Solar, alcanzando hasta 2,100 km/h.",
        "Su luna Tritón es uno de los cuerpos más fríos conocidos y orbita de manera retrógrada.",
      ],
    }
  ];
